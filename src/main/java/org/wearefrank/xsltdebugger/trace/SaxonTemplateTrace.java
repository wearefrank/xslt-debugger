...
@Getter
@NoArgsConstructor
public class SaxonTemplateTrace implements TemplateTrace{
    @Setter
    ...
    @Setter
    private Traceable traceType;

    public SaxonTemplateTrace(String templateTrace, SaxonTemplateTrace parentTrace){
